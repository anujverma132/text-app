    ...
    <>
      <div className="container my-3">
        ...
        {/* <p style={{color : props.mode==='dark'?'white':'#042743'}}>This is a Text Util App</p> */}
          <textarea style={{backgroundColor: props.mode==='dark'?'grey':'white',color : props.mode==='dark'?'white':'black' , width:'100%'}} rows="8" cols="150" value={text} onChange={textData} />
          <div className="my-2">
            <button style={{margin:'10px'}} onClick={toUppercase} className="btn btn-primary"> Convert To Upper case </button>
            <button style={{margin:'10px'}} onClick={toLowercase} className="btn btn-primary mx-2"> Convert To Lower case </button>
          </div>
      </div>
      <div className="container my-3">
